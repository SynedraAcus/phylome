"""
This file was copied koteth's implementation of MCL (original repository at
https://github.com/koteth/python_mcl), originally subject to MIT license. The
version is what was latest master branch at 12 april 2017.
"""
...
def networkx_mcl(G, expand_factor=2, inflate_factor=2, max_loop=10,
    ...
    return mcl(np.array(A.todense()), expand_factor, inflate_factor, max_loop,
               mult_factor)
